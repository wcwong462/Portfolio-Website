    ...
    <html lang="en" suppressHydrationWarning>
      ...
      >
        ...
        >
          ...
          <div className="relative z-0 min-h-screen bg-white/20 dark:bg-slate-950/20 backdrop-blur-sm w-full max-w-7xl mx-auto border-x border-primary/10 shadow-2xl transition-all duration-500">
            {children}
          </div>
